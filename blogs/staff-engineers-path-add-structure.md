...
**Over-owning the execution itself.** This is perhaps the most subtle version. You treat the project as a solo effort when your manager and the organization expect it to be a team effort. You put your head down, do excellent work, ship everything on time -- and still fail. Not because the output was wrong, but because you were expected to collaborate: to delegate to other engineers, to grow people through the work, to build shared ownership so the project survives without you. For the LLM Gateway, imagine you personally write the routing layer, the cost dashboard, and the monitoring pipeline. It all works. But your manager is disappointed because two engineers on the team were supposed to grow through this project, and instead they watched you do everything. You delivered the code but missed the actual expectation, which was to lead a team delivering the code. This is especially common for engineers transitioning from senior to staff, where the shift from "I deliver" to "I make sure the team delivers" is the whole point.

The fix is the same in all cases: before you step into a gap, ask first. "I noticed nobody seems to be owning the auth model for the gateway. Is that something your team is planning to cover, or should I take a first pass?" For decisions that touch your manager's scope: "I think we should commit to supporting the Search team's use case by Q3. Does that align with what you are thinking, or should we discuss scope first?" And for execution: "How do you see the work being split? Should I be doing this myself or should I be setting up others to do it?" These questions cost thirty seconds and can save weeks of friction.

Over-ownership is especially tempting for staff engineers because you are used to operating with broad scope and because doing the work yourself is faster in the short term. But broad scope does not mean you own everything. It means you are responsible for making sure everything is owned and the right people are doing the right work. Those are very different things.
